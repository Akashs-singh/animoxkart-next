                        ...
                        <div className="row">
                            ...
                            <div className="col-xl-9 col-lg-8 col-md-7 ">
                                    ...
                                    <div className="col-xl-6">
                                        <div className="blog-right">
                                            <div>
                                                ...
                                                <Link href="/blog/details" ><h4>you how all this mistaken idea of denouncing pleasure
                                ...
                                <div className="row blog-media">
                                    <div className="col-xl-6">
                                        <div className="blog-left">
                                            <Link href="/blog/details" ><img src={`/assets/images/blog/2.jpg`} className="img-fluid" alt=""/></Link>
                                        </div>
                                    </div>
                                    <div className="col-xl-6">
                                        <div className="blog-right">
                                ...
                                <div className="row blog-media">
                                    <div className="col-xl-6">
                                        <div className="blog-left">
                                            <Link href="/blog/details" ><img src={`/assets/images/blog/3.jpg`} className="img-fluid" alt=""/></Link>
                                        </div>
                                    </div>
                                    <div className="col-xl-6">
                                        <div className="blog-right">
                                ...
                                <div className="row blog-media">
                                    <div className="col-xl-6">
                                        <div className="blog-left">
                                            <Link href="/blog/details" ><img src={`/assets/images/blog/4.jpg`} className="img-fluid" alt=""/></Link>
                                        </div>
                                    </div>
                                    <div className="col-xl-6">
                                        <div className="blog-right">
