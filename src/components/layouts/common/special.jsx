                                        ...
                                        <div className="offer-slider">
                                            <div className="sec-1">
                                                <div className="product-box2">
                                                    <div className="media">
                                                        <Link href="/view/product/${product[0].id}" >
                                                            <img
                                                                className="img-fluid blur-up lazyload"
                                                                src={getImage(product[0].images)} alt="" />
                                                        </Link>
                                                        <div className="media-body align-self-center">
                                                            ...
                                                            <h4>{symbol}{product[0].price}
                                                                <del><span className="money">{symbol}{product[0].mrpPrice}</span></del>
                                                            </h4>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="product-box2">
                                                    <div className="media">
                                                        <Link href="/view/product/${product[1].id}" >
                                                            <img
                                                                className="img-fluid blur-up lazyload"
                                                                src={getImage(product[1].images)} alt="" />
                                                        </Link>
                                                        <div className="media-body align-self-center">
                                                            <div className="rating"><i className="fa fa-star"></i> <i
                                                                className="fa fa-star"></i> <i
                                                            ...
                                                            <h4>{symbol}{product[1].price}
                                                                <del><span className="money">{symbol}{product[1].mrpPrice}</span></del>
                                                            </h4>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div className="theme-card center-align">
                                        <div className="offer-slider">
                                            <div className="sec-1">
                                                <div className="product-box2">
                                                    <div className="media">
                                                        <Link href="/view/product/${product[3].id}" >
                                                            <img
                                                                className="img-fluid blur-up lazyload"
                                                                src={getImage(product[3].images)} alt="" />
                                                        </Link>
                                                        <div className="media-body align-self-center">
                                                            <div className="rating"><i className="fa fa-star"></i> <i
                                                                className="fa fa-star"></i> <i
                                                            ...
                                                            <h4>{symbol}{product[3].price}
                                                                <del><span className="money">{symbol}{product[3].mrpPrice}</span></del>
                                                            </h4>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="product-box2">
                                                    <div className="media">
                                                        <Link href="/view/product/${product[4].id}" >
                                                            <img
                                                                className="img-fluid blur-up lazyload"
                                                                src={getImage(product[4].images)} alt="" />
                                                        </Link>
                                                        <div className="media-body align-self-center">
                                                            <div className="rating"><i className="fa fa-star"></i> <i
                                                                className="fa fa-star"></i> <i
                                                            ...
                                                            <h4>{symbol}{product[4].price}
                                                                <del><span className="money">{symbol}{product[4].mrpPrice}</span></del>
                                                            </h4>
                                                        </div>
                                                    </div>
                                                </div>
