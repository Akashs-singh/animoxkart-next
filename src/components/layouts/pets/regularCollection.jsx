...
const mapStateToProps = (state, ownProps) => ({
    items: getRegularTagCollection(state.data.products, ownProps.type, "regular"),
    symbol: state.data.symbol
})

export default connect(mapStateToProps, {addToCartHome, addToWishlist, addToCompare}) (RegularCollection);