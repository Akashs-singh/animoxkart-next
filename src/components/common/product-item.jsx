...
import { addToCart, addToCartHome } from "../../actions/index";
                    ...
                    <div className="front">
                        ...
                        <Link href={`/view/product/${product.id}/${product.name}`} ><img
                            src={`${
                                ...
                                product.variants ?
                                    this.state.image ? this.state.image : product.variants.filter((variant) => variant.productCode == this.state.variantCode)[0].images
                                    : product.images
                                }`}
                            className="img-fluid"
