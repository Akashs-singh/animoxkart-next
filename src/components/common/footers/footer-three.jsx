                        ...
                        <div className="row footer-theme2">
                            <div className="col p-set">
                                <div className="footer-link">
                                    ...
                                    <div className="footer-contant">
                                        <ul>
                                            <li><Link href="/left-sidebar/collection">womens</Link>
                                            </li>
                                            <li><Link href="/left-sidebar/collection">clothing</Link>
                                            </li>
                                            <li><Link href="/left-sidebar/collection">accessories</Link>
                                            </li>
                                            <li><Link href="/left-sidebar/collection">featured</Link>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
