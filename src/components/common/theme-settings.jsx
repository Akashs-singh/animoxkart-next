...
class ThemeSettings extends Component {
    ...
    //         if (typeof document !== 'undefined') document.querySelector(".tap-top").style = "display: block";
    //     } else {
    //         if (typeof document !== 'undefined') document.querySelector(".tap-top").style = "display: none";
    //     }
    // }
    // clickToTop(){
    ...
    //     var elems = if (typeof document !== 'undefined') document.querySelectorAll(".color-box li");
                        ...
                        <div className="setting-body">
                                    ...
                                    <div className="col-sm-6 col-12 text-center demo-effects">
                                        <div className="set-position">
                                            ...
                                            <div className="demo-text">
                                                ...
                                                <div className="btn-group demo-btn" role="group"
                                                     aria-label="Basic example">
                                                    <Link href="/right-sidebar/collection"
                                                          className="btn new-tab-btn">Preview
                                                    </Link>
                                                </div>
                                            </div>
                                    ...
                                    <div className="col-sm-6 col-12 text-center demo-effects">
                                        <div className="set-position">
                                            ...
                                            <div className="demo-text">
                                                ...
                                                <div className="btn-group demo-btn" role="group"
                                                     aria-label="Basic example">
                                                    <Link href="/no-sidebar/collection"
                                                          className="btn new-tab-btn">Preview
                                                    </Link>
                                                </div>
                                            </div>
                                    ...
                                    <div className="col-sm-6 col-12 text-center demo-effects">
                                        <div className="set-position">
                                            ...
                                            <div className="demo-text">
                                                ...
                                                <div className="btn-group demo-btn" role="group"
                                                     aria-label="Basic example">
                                                    <Link href="/full-width/collection"
                                                          className="btn new-tab-btn">Preview
                                                    </Link>
                                                </div>
                                            </div>
                                    ...
                                    <div className="col-sm-6 col-12 text-center demo-effects">
                                        <div className="set-position">
                                            ...
                                            <div className="demo-text">
                                                ...
                                                <div className="btn-group demo-btn" role="group"
                                                     aria-label="Basic example">
                                                    <Link href="/left-sidebar/product/1"
                                                          className="btn new-tab-btn">Preview
                                                    </Link>
                                                </div>
                                            </div>
                                    ...
                                    <div className="col-sm-6 col-12 text-center demo-effects">
                                        <div className="set-position">
                                            ...
                                            <div className="demo-text">
                                                ...
                                                <div className="btn-group demo-btn" role="group"
                                                     aria-label="Basic example">
                                                    <Link href="/right-sidebar/product/1"
                                                          className="btn new-tab-btn">Preview
                                                    </Link>
                                                </div>
                                            </div>
                                    ...
                                    <div className="col-sm-6 col-12 text-center demo-effects">
                                        <div className="set-position">
                                            ...
                                            <div className="demo-text">
                                                ...
                                                <div className="btn-group demo-btn" role="group"
                                                     aria-label="Basic example">
                                                    <Link href="/no-sidebar/product/1"
                                                          className="btn new-tab-btn">Preview
                                                    </Link>
                                                </div>
                                            </div>
                                    ...
                                    <div className="col-sm-6 col-12 text-center demo-effects">
                                        <div className="set-position">
                                            ...
                                            <div className="demo-text">
                                                ...
                                                <div className="btn-group demo-btn" role="group"
                                                     aria-label="Basic example">
                                                    <Link href="/left-image/product/1"
                                                          className="btn new-tab-btn">Preview
                                                    </Link>
                                                </div>
                                            </div>
                                    ...
                                    <div className="col-sm-6 col-12 text-center demo-effects">
                                        <div className="set-position">
                                            ...
                                            <div className="demo-text">
                                                ...
                                                <div className="btn-group demo-btn" role="group"
                                                     aria-label="Basic example">
                                                    <Link href="/right-image/product/1"
                                                          className="btn new-tab-btn">Preview
                                                    </Link>
                                                </div>
                                            </div>
                            ...
                            <div className="buy_btn">
                                ...
                                <a href="https://themeforest.net/item/multikart-responsive-angular-ecommerce-template/22905358?s_rank=3"
                                   target="_blank" className="btn btn-block purchase_btn">
                                    <img src={`/assets/images/icon/angular.png`} alt="" className="img-fluid" /> Multikart Angular</a>
                                ...
                                <a href="https://themeforest.net/item/multikart-multipurpose-shopify-sections-theme/23093831?s_rank=1"
                                   target="_blank" className="btn btn-block purchase_btn">
                                    <img src={`/assets/images/icon/shopify.png`} alt="" className="img-fluid" /> Multikart Shopify</a>
                            </div>
                        </div>
                    </div>
                </div>
