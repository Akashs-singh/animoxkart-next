                    ...
                    <div className="container-fluid">
                        ...
                        <div className="home-decor">
                            <div className="decor-1 decor wow zoomIn" id="img-1">
                                <img src={`/assets/images/landing-page/slider/1.png`} alt=""
                                    className="img-fluid lazyload" />
                            </div>
                            <div className="decor-2 decor wow zoomIn" id="img-2">
                                <img src={`/assets/images/landing-page/slider/5.png`} alt=""
                                    className=" img-fluid lazyload" />
                            </div>
                            <div className="decor-3 decor wow zoomIn" id="img-3">
                                <img src={`/assets/images/landing-page/slider/2.png`} alt=""
                                    className=" img-fluid lazyload" />
                            </div>
                            <div className="decor-4 decor wow zoomIn" id="img-4">
                                <img src={`/assets/images/landing-page/slider/4.png`} alt=""
                                    className=" img-fluid lazyload" />
                            </div>
                            <div className="decor-5 decor wow zoomIn" id="img-5">
                                <img src={`/assets/images/landing-page/slider/3.png`} alt=""
                                    className=" img-fluid lazyload" />
                            </div>
                            <div className="decor-6 decor wow zoomIn" id="img-6">
                                <img src={`/assets/images/landing-page/slider/6.png`} alt=""
                                    className=" img-fluid lazyload" />
                            </div>
                            <div className="decor-7 decor wow zoomIn" id="img-7">
                                <img src={`/assets/images/landing-page/slider/11.png`} alt=""
                                    className=" img-fluid lazyload" />
                            </div>
                            <div className="decor-8 decor wow zoomIn" id="img-8">
                                <img src={`/assets/images/landing-page/slider/7.png`} alt=""
                                    className=" img-fluid lazyload" />
                            </div>
                            <div className="decor-9 decor wow zoomIn" id="img-9">
                                <img src={`/assets/images/landing-page/slider/8.png`} alt=""
                                    className=" img-fluid lazyload" />
                            </div>
                            <div className="decor-10 decor wow zoomIn" id="img-10">
                                <img src={`/assets/images/landing-page/slider/10.png`} alt=""
                                    className=" img-fluid lazyload" />
                            </div>
                            <div className="decor-11 decor wow zoomIn" id="img-11">
                                <img src={`/assets/images/landing-page/slider/9.png`} alt=""
                                    className=" img-fluid lazyload" />
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="row feature_row">
                                ...
                                <div className="feature-box">
                                    <div className="feature-image">
                                        <img className="img-fluid lazyload"
                                            src={`/assets/images/landing-page/main-features/demo.png`} alt="img" />
                                    </div>
                            ...
                            <div className="col-xl-3 col-md-6">
                                <div className="feature-box">
                                    <div className="feature-image">
                                        <img className="img-fluid lazyload"
                                            src={`/assets/images/landing-page/main-features/portfoio.png`} alt="img" />
                                    </div>
                                    <div className="feature-content">
                                        <ul className="color-varient">
                                            <li className="red"></li>
                            ...
                            <div className="col-xl-3 col-md-6 ">
                                <div className="feature-box">
                                    <div className="feature-image">
                                        <img className="img-fluid lazyload" src={`/assets/images/landing-page/main-features/lazy.png`} alt="img" />
                                    </div>
                                    <div className="feature-content">
                                        <ul className="color-varient">
                                            <li className="red"></li>
                            ...
                            <div className="col-xl-3 col-md-6 ">
                                <div className="feature-box">
                                    <div className="feature-image">
                                        <img className="img-fluid lazyload" src={`/assets/images/landing-page/main-features/Unlimited-product-size.png`} alt="img" />
                                    </div>
                                    <div className="feature-content">
                                        <ul className="color-varient">
                                            <li className="red"></li>
                            ...
                            <div className="col-xl-3 col-md-6">
                                <div className="feature-box">
                                    <div className="feature-image">
                                        <img className="img-fluid lazyload" src={`/assets/images/landing-page/main-features/Dark-light.png`} alt="img" />
                                    </div>
                                    <div className="feature-content">
                                        <ul className="color-varient">
                                            <li className="red"></li>
                            ...
                            <div className="col-xl-3 col-md-6">
                                <div className="feature-box">
                                    <div className="feature-image">
                                        <img className="img-fluid lazyload" src={`/assets/images/landing-page/main-features/rtl.png`} alt="img" />
                                    </div>
                                    <div className="feature-content">
                                        <ul className="color-varient">
                                            <li className="red"></li>
                        ...
                        <Tabs className="theme-tab">
                                ...
                                <div>
                                    <div className="row">
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link href="/fashion" target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link href="/vegetables" target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link href="/beauty" target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link href="/electronic" target="_blank">
                            ...
                            <TabPanel>
                                <div>
                                    <div className="row">
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link href="/col-left/product/1" target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link href="/column/product/1" target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link href="/accordian/product/1" target="_blank">
                                                <img src={`/assets/images/landing-page/special features/product/4.jpg`}
                                                    className="img-fluid lazyload" />
                                                <h3>accordian</h3>
                                            </Link>
                                        </div>
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link href="/left-image/product/1" target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link href="/left-sidebar/product/1" target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link href="/no-sidebar/product/1" target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link href="/right-image/product/1" target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link href="/right-sidebar/product/1" target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link href="/vertical/product/1" target="_blank">
                                                <img src={`/assets/images/landing-page/special features/product/11.jpg`}
                                                    className="img-fluid lazyload" />
                                                <h3>vertical tab</h3>
                                            </Link>
                                        </div>
                            ...
                            <TabPanel>
                                <div>
                                    <div className="row">
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link href="/metro/collection" target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link href="/full-width/collection" target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link href="/left-sidebar/collection" target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link href="/no-sidebar/collection" target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link href="/right-sidebar/collection" target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link href="/left-sidebar/collection" target="_blank">
                                                <img src={`/assets/images/landing-page/special features/shop/5.jpg`}
                                                    className="img-fluid lazyload" />
                            ...
                            <TabPanel>
                                <div>
                                    <div className="row">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link href="/pages/dashboard" target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link href="/pages/login" target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link href="/pages/register" target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link href="/pages/contact" target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link href="/pages/forgot-password" target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link href="/pages/about-us" target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link href="/pages/search" target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link href="/compare" target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link href="/pages/collection" target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link href="/pages/lookbook" target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link href="/pages/404" target="_blank">
                            ...
                            <TabPanel>
                                <div>
                                    <div className="row">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link href="/blog/blog-page" target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link href="/blog/right-sidebar" target="_blank">
                ...
                <section id="admin" className="section-b-space pt-0">
                    ...
                    <div className="col-xl-3 col-sm-6 col-12 demo-box">
                        <a href="https://react.pixelstrap.com/multikart-admin/dashboard" target="_blank">
                            <img src={`/assets/images/landing-page/admin/1.jpg`} className="img-fluid lazyload" />
                        </a>
                        <h3>dashboard</h3>
                    </div>
                    <div className="col-xl-3 col-sm-6 col-12 demo-box">
                        <a href="https://react.pixelstrap.com/multikart-admin/products/physical/product-list" target="_blank">
                            <img src={`/assets/images/landing-page/admin/2.jpg`} className="img-fluid lazyload" />
                        </a>
                        <h3>product list</h3>
                    </div>
                    <div className="col-xl-3 col-sm-6 col-12 demo-box">
                        <a href="https://react.pixelstrap.com/multikart-admin/reports/report" target="_blank">
                            <img src={`/assets/images/landing-page/admin/3.jpg`} className="img-fluid lazyload" />
                        </a>
                        <h3>report page</h3>
                    </div>
                    <div className="col-xl-3 col-sm-6 col-12 demo-box">
                        <a href="https://react.pixelstrap.com/multikart-admin/media" target="_blank">
                            <img src={`/assets/images/landing-page/admin/4.jpg`} className="img-fluid lazyload" />
                        </a>
                        <h3>media page</h3>
                    </div>
                </div>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-md-3 left-part">
                                <img src={`/assets/images/landing-page/email%20template/1.jpg`} alt=""
                                    className="img-fluid lazyload email-img" />
                                <div className="sticker">
                                    <img src={`/assets/images/landing-page/email%20template/sticker.png`} alt=""
                                        className="img-fluid lazyload" />
                                </div>
                            </div>
                            <div className="col-md-4 offset-md-1 text-center center-part">
                                ...
                                <img src={`/assets/images/landing-page/email%20template/2.jpg`} alt=""
                                    className="img-fluid lazyload email-img full-img" />
                                <div className="res-img">
                                    <img src={`/assets/images/landing-page/email%20template/1.png`} alt=""
                                        className="img-fluid lazyload" />
                                </div>
                            </div>
                            <div className="col-md-3 offset-md-1 right-part">
                                <img src={`/assets/images/landing-page/email%20template/3.jpg`} alt=""
                                    className="img-fluid lazyload email-img" />
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="col-xl-2 col-md-3 col-6">
                                <div className="theme-collection">
                                    <div>
                                        <div className="image-contain">
                                            <div className="set-image">
                                                <img src={`/assets/images/landing-page/icon/13.png`} alt="fetures" />
                                            </div>
                                        </div>
