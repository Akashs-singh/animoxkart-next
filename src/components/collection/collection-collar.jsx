...
class CollectionCollar extends Component {
    ...
    render (){
        ...
        return (
            <div>
                ...
                <Breadcrumb title={'Collection'} parent={'Collar'}/>
                                    ...
                                    <div className="page-main-content">
                                        <div className="top-banner-wrapper">
                                            ...
                                            <div className="top-banner-content small-section pb-0">
                                                <h2 style={{"fontSize":"24px"}}>Dog Collars</h2>
                                                <h5>Unleash the bond with the perfect dog collar for your furry friend.</h5>
                                                <h6>Dog collars are an essential accessory for any dog owner. They serve as a means of identification, control and training.</h6>
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            <h6>Dog collars are an essential accessory for any dog owner. They serve as a means of identification, control and training. There are a variety of different types of dog collars available to suit different breeds and needs. The most common types of dog collars are the flat collar, which is a simple band of material that goes around the dog's neck.</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
const mapStateToProps = (state) => ({
    products: getCategoryTagCollections(state.data, "wearable","collar"),
