    ...
    render (){
        ...
        return (
            <div>
                     {/*SEO Support*/}
                     {/*SEO Support End */}
                <Breadcrumb title={'Collection'} parent={'Offers'}/>
                                    ...
                                    <div className="page-main-content">
                                        <div className="top-banner-wrapper">
                                            ...
                                            <div className="top-banner-content small-section pb-0">
                                                <h2 style={{"fontSize":"24px"}}>Offers</h2>
                                                <h5>Unleash the savings on essential dog gear.</h5>
                                            </div>
                                        </div>
...
const mapStateToProps = (state) => ({
    products: getProductTagCollections(state.data, "wearable","offers"),
